...
<html lang="en">
    ...
    <body>
        <script>
            // If user clicked logout link which points to login?logout=1,
                ...
                <div class="left justify-content-center align-items-center w-100 w-md-50">
                    <div class="form-wrapper">
                        ...
                        <form id="loginForm">
                            ...
                            <div id="loginError" class="text-danger fs-small mb-2"></div>
        ...
        <script src="/frontend/js/sign-in.js"></script>
    </body>
</html>
