...
<body>
    ...
    <main class="fade-page signup-page">
        <!-- Header banner -->
        <div class="signup-header-banner">
            <!-- Header nav -->
            <div class="header-nav-in-banner container">
                <div class="nav-in-banner d-flex align-items-center justify-content-between pt-3 pb-2">
                    <div class="nav-left d-flex align-items-center">
                        <img src="{{ asset('images/Logo-01.png') }}" alt="logo" class="nav-logo me-2">
                    ...
                    <div class="nav-right-in-banner d-flex align-items-center">
            ...
            <!-- Text center -->
            <div class="text-center banner-welcome-text">
                <h1 class="fw-bold mb-3 fs-1">Welcome!</h1>
                <p class="fs-6 opacity-75">
                    Welcome! Use these forms to sign in to your Modalab Dashboard
                    or register a new, complimentary account.
                </p>
            </div>
        ...
        <div class="signup-card-container">
            <div class="card signup-card shadow-lg p-4">
                <div class="card-body">
                    ...
                    <h3 class="fs-5 fw-bold text-center mb-4 text-dark">Register with</h3>

                    <div class="d-flex justify-content-center mb-4 gap-3">
                        <a href="#" class="btn btn-outline-social">
                    ...
                    <form id="signupForm">
                        <div class="mb-3">
                            <label class="form-label fs-small ">Full Name</label>
                            <input type="text" id="fullNameInput" class="form-control" placeholder="Your full name">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" id="passwordInput" class="form-control" placeholder="Your password">
                        </div>

                        <button type="button" id="signUpBtn" class="btn btn-primary fw-bold w-100 mb-3">SIGN UP</button>
                    </form>

                    <div class="text-center fs-small">
                        Already have an account?
                        <a href="{{ url('/') }}" class="link-page fw-medium text-decoration-none">Sign in</a>
                    </div>
    ...
    <!-- FOOTER -->
    <footer class="footer footer-signup">
