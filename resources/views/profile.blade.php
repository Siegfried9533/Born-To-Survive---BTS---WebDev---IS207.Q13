                    ...
                    <div class="card profile-card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    <h5 class="mb-0 fw-bold">Sofia Carson</h5>
                                    <span class="text-muted fs-small">sofia.carson@modalab.com</span>
                                </div>
                            ...
                            <form class="mt-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" value="sofia.carson@modalab.com"
                                        disabled>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="reset-pwd.html" class="btn btn-sm btn-outline-primary ms-3">Reset</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm profile-widget">
                        <div class="card-body">
                            ...
                            <div id="task-notification-area" class="mt-2"></div>

                            <div id="task-list-area" class="mt-2">
                            </div>

                            <form id="task-add-form" class="mt-2" style="display: none;">
                                <hr class="my-3">
                                <label class="form-label fs-small fw-bold" id="task-form-label">Add Task for...</label>
