...
@section('title', 'Top SubSubCategory Analysis')
    ...
    <section class="container-fluid-dashboard px-4 pb-5">
        <div class="card section-card shadow-sm">
            ...
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3 px-4">
                <h5 class="mb-0 fw-semibold text-dark">Top SubCategory Growth GMV</h5>
                <button id="downloadSubCategoryBtn" class="btn btn-sm btn-primary d-flex align-items-center gap-2">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0 growth-table" id="topSubCategoryTable">
...
@push('scripts')
    @vite('resources/js/top-subcategory.js')
