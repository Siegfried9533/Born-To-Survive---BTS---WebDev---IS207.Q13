        ...
        <div class="signin-container d-flex flex-column flex-md-row vh-100">
            ...
            <div class="left justify-content-center align-items-center w-100 w-md-50">
                <div class="form-wrapper">
                    ...
                    <p class="mb-4">Enter your new password to change</p>
                    ...
                    <form id="resetPasswordForm">
                        <div class="mb-3">
                            ...
                            <div class="password-toggle-group">
                                ...
                                <i class="fa-solid fa-eye-slash password-toggle-icon"
                                    data-target="#newPasswordInput"></i>
                            </div>

                            <div id="passwordStrengthMeter" class="mt-2">
                                <div id="strengthBar" class="strength-bar"></div>
                                <p id="strengthText" class="fs-small"></p>
                                <ul id="passwordRequirements" class="fs-small text-muted ps-3 mt-1"></ul>
                            </div>
                        </div>
                        ...
                        <button type="button" id="resetBtn" class="btn btn-primary fw-bold w-100 mb-3">Reset</button>
                    </form>
                </div>
            </div>
