...
function initOverviewChartsFromFile() {
  ...
  $.get("/fake-data/overview-data.txt", function (text) {
    ...
    alert(
      "Lỗi: Không tìm thấy dữ liệu. Vui lòng kiểm tra file /fake-data/overview-data.txt"
    );
  });
}
...
function initSalesGrowthTable() {
  const dataPath = "/fake-data/growth-data.txt";
...
function initTopCategory() {
  ...
  $.get("/fake-data/top-category-data.txt", function (text) {
    const lines = text
      .replace(/^\uFEFF/, "")
      .replace(/\r\n?/g, "\n")
      .trim()
...
function initTopProducts() {
  ...
  $.get("/fake-data/top-products-data.txt", function (text) {
    const lines = text
      .replace(/^\uFEFF/, "")
      .replace(/\r\n?/g, "\n")
      .trim()
...
// CUSTOMERS
// =======================================================
const dataPath = "/fake-data/customers-data.txt";
...
$(document).ready(function () {
  ...
  const dataPath = "/fake-data/stores-data.txt";
  let data = [];
